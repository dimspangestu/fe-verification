...
const inputCls = "h-11 w-full rounded-xl border border-slate-200 bg-white px-3 text-sm font-semibold text-slate-900 placeholder:text-slate-400 outline-none focus:border-emerald-300 focus:ring-4 focus:ring-emerald-100 transition";
...
const btnPrimary  = "h-11 rounded-xl px-5 text-sm font-black bg-emerald-600 text-white hover:bg-emerald-700 active:scale-95 transition";
...
export default function InvestorAccountPage() {
  ...
  return (
    <InvestorLayout title="Akun & Keamanan">
      ...
      <div className="max-w-[600px] space-y-4">
        ...
        <div className="flex items-center gap-4 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          <div className="grid h-14 w-14 shrink-0 place-items-center rounded-2xl border border-emerald-100 bg-emerald-50 text-lg font-black text-emerald-600">
            {(name || email || "I").slice(0, 2).toUpperCase()}
          </div>
          <div className="min-w-0">
            ...
            <span className="mt-1.5 inline-flex rounded-full border border-emerald-200 bg-emerald-50 px-2 py-0.5 text-[10px] font-black text-emerald-600">
              Investor
            </span>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white shadow-sm">
          ...
          <div className="p-5">
            ...
            {tab === "email" && (
              <ChangeEmail currentEmail={email} showToast={showToast}
